...
pub mod ecvrf {
    ...
    /// designs should specify a different suite_string constant, so we use "mgo_vrf" here.
    const SUITE_STRING: &[u8; 7] = b"mgo_vrf";
    ...
    const DST: &[u8; 49] = b"ECVRF_ristretto255_XMD:SHA-512_R255MAP_RO_mgo_vrf";
