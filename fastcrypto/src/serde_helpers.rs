...
///
/// Note that in theory external types should not be stored in Mgo and only be serialized with
/// is_human_readable(). For storage and computation in Mgo, internal types should be used (see
/// above).
///
